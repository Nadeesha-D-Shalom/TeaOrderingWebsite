...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update DB
    if (!$error) {
        $sql = "UPDATE tea_products SET name='$name', description='$desc', image='$imagePath' WHERE id=$id";
        if (mysqli_query($conn, $sql)) {
            $success = "Tea product updated successfully.";
...
<div class="container">
    <h3 class="mb-4">Edit Tea Product</h3>
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="text-center mt-4">
            ...
            <a href="tea_manager.php" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>
